...
#python -m semi_supervised_evaluation \
#    --experiment_config_path configs/barlow/inertial_skeleton_barlow_preserved_czu.yaml \
#    --dataset czu_mhad \
#    --data_path /home/data/multimodal_har_datasets/czu_mhad  \
#    --modalities inertial skeleton \
#    --models transformer cooccurrence \
...
## VICReg preserved.
python -m semi_supervised_evaluation \
    --experiment_config_path configs/VICReg/vicreg_inertial_skeleton_preserved_czu.yaml \
    --dataset czu_mhad \
    --data_path /home/data/multimodal_har_datasets/czu_mhad  \
    --modalities inertial skeleton \
    --models transformer cooccurrence \
